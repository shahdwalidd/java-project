...
<html lang="en">
<head>
  <meta charset="UTF-8"><title>Error ${requestScope.errorCode}</title>
  <style>
    ...
    .code { font-size: 80px; font-weight: 900; color: #ef4444; line-height: 1; }
...
<body>
  <div class="box">
    <div class="code">${requestScope.errorCode}</div>
